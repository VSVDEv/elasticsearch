package com.vsvdev.es_link_raiting.controllers;

import com.vsvdev.es_link_raiting.AdminService;
import com.vsvdev.es_link_raiting.entiry.Link;
import com.vsvdev.es_link_raiting.entiry.User;
...
public class LinkController extends BaseController {
    ...
    @Inject
    public LinkController(@Qualifier("elasticsearchOperations") ElasticsearchOperations elasticsearchTemplate, AdminService adminService) {
